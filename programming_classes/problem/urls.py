...
urlpatterns = [
    ...
    path(
        'competitions/<int:competition_id>/problems/create/',
        views.ProblemCreateView.as_view(),
        name='competition-problem-create',
    ),
    path('competitions/<int:competition_id>/problems/upload/', views.bulk_problem_upload, name='bulk-problem-upload'),
    path(
        'competitions/<int:competition_id>/problems/batch/',
        views.problem_batch_operations,
        name='problem-batch-operations',
    ),
    path(
        'api/competitions/<int:competition_id>/problems/export/', views.export_problems_api, name='export-problems-api'
    ),
    path(
