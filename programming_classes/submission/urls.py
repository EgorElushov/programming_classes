...
urlpatterns = [
    ...
    path('submissions/<int:submission_id>/update-status/', views.update_submission_status, name='update-submission-status'),
    ...
    path('competitions/<int:competition_id>/submissions/', views.competition_submissions, name='competition-submissions'),
    ...
    path('api/submissions/<int:submission_id>/status/', views.check_submission_status_api, name='api-check-submission-status'),
    path('api/submissions/<int:submission_id>/update-status/', views.update_submission_status_api, name='api-update-submission-status'),
